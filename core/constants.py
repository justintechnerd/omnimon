...
__all__ = [
    ...
    "BACKGROUND_COLOR", "FONT_COLOR_GRAY", "LEVEL_ICON_PATH", "EXP_ICON_PATH", "FONT_COLOR_RED",
    ...
    # Paths: Battle & Training Sprites
    "BATTLE_BACKGROUND_PATH", "TRAINING_BACKGROUND_PATH", "HEADTRAINING_PATH", "ARMOR_EVOLUTION_ICON_PATH",
    "BATTLE_ICON_PATH", "HEAD_TRAINING_ICON_PATH", "JOGRESS_ICON_PATH", "VS_PATH", "VERSUS_BATTLE_ICON_PATH",
    ...
    "DUMMY_TRAINING_ICON_PATH", "SHAKE_MATCH_ICON_PATH", "BRICK1_PATH", "BRICK2_PATH", "BOSS_MULTIPLIER",
